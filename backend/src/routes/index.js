...
module.exports = () => {
	...
	router.put(
		'/api/v1/add-psychological-habit',
		customerController.addPsychologicalHabit
	);
	...
	router.post(
		'/api/v1/list-customer-nutritionist',
		customerController.listCustomerNutritionist
	);
	router.post('/api/v1/formulas', customerController.formulas);
